...
def build_irregular_df():
    df = pd.DataFrame({
        'timestamp': [
            '2025-01-01 10:00:00', '2025-01-01 10:15:00', '2025-01-01 10:45:00',
            '2025-01-01 11:50:00', '2025-01-01 12:00:00', '2025-01-01 13:15:00'
        ],
...
def plot_gp_predictions(df: pd.DataFrame, plot: bool = False):
    ...
    gp = GaussianProcessRegressor(kernel=RBF(length_scale=30.0), alpha=1e-2, normalize_y=True, random_state=42)
