...
df = pd.DataFrame({
    'timestamp': ['2025-01-01 10:00:00', '2025-01-01 10:15:00', '2025-01-01 10:45:00'],
    'value': [10, 15, 20]
})
...
gp = GaussianProcessRegressor(kernel=RBF(length_scale=10.0), alpha=1e-6, normalize_y=True, random_state=42)
